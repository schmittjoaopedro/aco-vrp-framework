...
public class ConsolidateReportsUtils {
    ...
    public static void main(String[] args) throws Exception {
        String[] instances = InstanceUtils.instances_800;
        ...
        // Fill first row
        int k = 1;
        for (int j = 0; j < InstanceUtils.dynamic_suffixes.length; j++) {
            algorithmData[0][k++] = InstanceUtils.dynamic_suffixes[j] + "_nv";
            algorithmData[0][k++] = InstanceUtils.dynamic_suffixes[j] + "_tc";
            algorithmData[0][k++] = InstanceUtils.dynamic_suffixes[j] + "_fc";
        }
        // Fill body data
