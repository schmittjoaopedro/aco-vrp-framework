...
public class MMAS_ADTSP_Test {
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA100_with_seed_1_mag_0_5_freq_100() {
        ...
        MMAS_ADTSP mmas_adtsp = new MMAS_ADTSP(graph, 0.8, 1000, 0.5, 100);
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA100_with_seed_1_mag_0_75_freq_100() {
        ...
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(32236.10157581001);
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA100_with_seed_1_mag_0_5_freq_10() {
        Graph graph = GraphFactory.createGraphFromTSP(new File(kroA100));
        MMAS_ADTSP mmas_adtsp = new MMAS_ADTSP(graph, 0.8, 100, 0.5, 10);
        mmas_adtsp.setMmasSeed(1);
        mmas_adtsp.setDbgpSeed(1);
        mmas_adtsp.setStatisticInterval(1);
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(30577.058119669073);
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA100_with_seed_1_mag_0_75_freq_10() {
        Graph graph = GraphFactory.createGraphFromTSP(new File(kroA100));
        MMAS_ADTSP mmas_adtsp = new MMAS_ADTSP(graph, 0.8, 100, 0.75, 10);
        mmas_adtsp.setMmasSeed(1);
        mmas_adtsp.setDbgpSeed(1);
        mmas_adtsp.setStatisticInterval(1);
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(35438.85374944973);
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA200_with_seed_1_mag_0_5_freq_100() {
        ...
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(36457.178132921756);
        ...
        assertThat(mmas_adtsp.getGlobalStatistics().getTimeStatistics().get("MMAS Execution")).isLessThan(35000);
        assertThat(mmas_adtsp.getGlobalStatistics().getTimeStatistics().get("MMAS Initialization")).isLessThan(150);
    }
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA200_with_seed_1_mag_0_75_freq_100() {
        ...
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(47135.782063333194);
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA200_with_seed_1_mag_0_5_freq_10() {
        ...
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(44874.526172962025);
        ...
        assertThat(mmas_adtsp.getGlobalStatistics().getTimeStatistics().get("MMAS Execution")).isLessThan(5000);
        assertThat(mmas_adtsp.getGlobalStatistics().getTimeStatistics().get("MMAS Initialization")).isLessThan(150);
    }
    ...
    public void test_mmas_asymmetric_dynamic_tsp_kroA200_with_seed_1_mag_0_75_freq_10() {
        ...
        mmas_adtsp.setShowLog(false);
        mmas_adtsp.run();
        assertThat(mmas_adtsp.getGlobalStatistics().getBestSoFar()).isEqualTo(50917.69414187545);
