...
public class MPDPTW_ALNS_TEST {
    ...
    public void mpdptw_large_4_25_1_test() throws Exception {
        ...
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 4 BFS = 4876.311938952875, feasible = true");
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 36 BFS = 4585.850993238566, feasible = true");
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 900 BFS = 4585.850993238565, feasible = true");
        assertThat(log.get(3)).contains("Instance = l_4_25_1.txt\n" +
    ...
    public void mpdptw_normal_4_25_1_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 3 BFS = 5108.860823037317, feasible = true");
    ...
    public void mpdptw_without_4_25_1_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 2 BFS = 3982.772943037291, feasible = true");
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 594 BFS = 3979.501754513747, feasible = true");
        assertThat(log.get(2)).contains("Instance = w_4_25_1.txt\n" +
                "Best solution feasibility = true\n" +
                "Routes\n" +
    ...
    public void mpdptw_large_8_50_1_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 68 BFS = 6221.1468619143625, feasible = true");
    ...
    public void mpdptw_normal_8_50_1_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 10 BFS = 7631.966003915071, feasible = true");
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 8400 BFS = 7631.96600391507, feasible = true");
    ...
    public void mpdptw_without_8_50_1_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 36 BFS = 4793.62827780313, feasible = true");
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 38 BFS = 4662.937035954059, feasible = true");
        assertThat(log.get(2)).isEqualTo("NEW BEST = Iter 138 BFS = 4574.279678062881, feasible = true");
        assertThat(log.get(3)).isEqualTo("NEW BEST = Iter 1252 BFS = 4571.69645898469, feasible = true");
        assertThat(log.get(4)).isEqualTo("NEW BEST = Iter 1500 BFS = 4569.1382309839555, feasible = true");
    ...
    public void mpdptw_without_8_25_3_test() throws Exception {
        ...
        alns.execute();
        List<String> log = alns.getLog();
        assertThat(log.get(0)).isEqualTo("NEW BEST = Iter 1 BFS = 3030.2826703620926, feasible = true");
        assertThat(log.get(1)).isEqualTo("NEW BEST = Iter 1264 BFS = 2950.7741171841853, feasible = true");
        assertThat(log.get(2)).contains("Instance = w_8_25_3.txt\n" +
                "Best solution feasibility = true\n" +
                "Routes\n" +
