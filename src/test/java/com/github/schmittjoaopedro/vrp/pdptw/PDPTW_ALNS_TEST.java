...
public class PDPTW_ALNS_TEST {
    ...
    static {
        ...
        pdptw400Directory = Paths.get(DVRPTW_ACS_Test.class.getClassLoader().getResource("pdp_400").getFile().substring(1)).toString();
        pdptw600Directory = Paths.get(DVRPTW_ACS_Test.class.getClassLoader().getResource("pdp_600").getFile().substring(1)).toString();
    }
    ...
    @Test
    public void pdptw_lrc2_2_4_test() throws IOException {
        String problem = "LRC2_4_4.txt";
        ProblemInstance instance = DataReader.getPdptwInstance(Paths.get(pdptw400Directory, problem).toFile());
        ALNS alns = new ALNS(instance, maxIterations, new Random(1));
        alns.execute();
    }
