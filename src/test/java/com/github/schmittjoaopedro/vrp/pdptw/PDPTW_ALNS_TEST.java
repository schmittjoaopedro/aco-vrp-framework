...
public class PDPTW_ALNS_TEST {
    ...
    public void pdptw_lc103_test() throws IOException {
        ...
        assertThat(logs.get(2)).isEqualTo("NEW BEST = Iter 7 BFS = 838.2998327659866, feasible = true");
        assertThat(logs.get(3)).isEqualTo("NEW BEST = Iter 8 BFS = 827.8646991698505, feasible = true");
        assertThat(logs.get(4)).isEqualTo("NEW BEST = Iter 3800 BFS = 827.8646991698504, feasible = true");
        assertThat(logs.get(5)).contains("Instance = lc103.txt\n" +
    ...
    public void pdptw_lrc102_test() throws IOException {
        ...
        assertThat(logs.get(2)).isEqualTo("NEW BEST = Iter 2 BFS = 1748.5334706917072, feasible = true");
        assertThat(logs.get(3)).isEqualTo("NEW BEST = Iter 101 BFS = 1669.4112103297268, feasible = true");
        assertThat(logs.get(4)).isEqualTo("NEW BEST = Iter 1081 BFS = 1638.9900063024345, feasible = true");
        assertThat(logs.get(5)).isEqualTo("NEW BEST = Iter 2204 BFS = 1621.6304878026936, feasible = true");
        assertThat(logs.get(6)).isEqualTo("NEW BEST = Iter 3306 BFS = 1615.2212705896682, feasible = true");
        assertThat(logs.get(7)).isEqualTo("NEW BEST = Iter 6234 BFS = 1574.5150862397759, feasible = true");
        assertThat(logs.get(8)).isEqualTo("NEW BEST = Iter 7800 BFS = 1574.5150862397757, feasible = true");
        assertThat(logs.get(9)).isEqualTo("NEW BEST = Iter 8257 BFS = 1563.5504554244735, feasible = true");
        assertThat(logs.get(10)).isEqualTo("NEW BEST = Iter 9396 BFS = 1558.0693464846545, feasible = true");
        assertThat(logs.get(11)).contains("Instance = lrc102.txt\n" +
                "Best solution feasibility = true\n" +
                "Routes\n" +
    ...
    public void pdptw_LC1_2_1_test() throws IOException {
        ...
        assertThat(logs.get(2)).isEqualTo("NEW BEST = Iter 1 BFS = 3609.63444252752, feasible = true");
        assertThat(logs.get(3)).isEqualTo("NEW BEST = Iter 2 BFS = 3466.633103897806, feasible = true");
        assertThat(logs.get(4)).isEqualTo("NEW BEST = Iter 3 BFS = 3292.4725138168624, feasible = true");
        assertThat(logs.get(5)).isEqualTo("NEW BEST = Iter 6 BFS = 3069.979722975791, feasible = true");
        assertThat(logs.get(6)).isEqualTo("NEW BEST = Iter 9 BFS = 2914.0989881480077, feasible = true");
        assertThat(logs.get(7)).isEqualTo("NEW BEST = Iter 13 BFS = 2704.5677663304737, feasible = true");
        assertThat(logs.get(8)).isEqualTo("NEW BEST = Iter 100 BFS = 2704.567766330473, feasible = true");
        assertThat(logs.get(9)).isEqualTo("NEW BEST = Iter 7700 BFS = 2704.5677663304728, feasible = true");
