...
public class MMAS_TSP_Test {
    ...
    public void test_MMAS_tsp_joinville46_with_seed_1() {
        ...
        mmas_tsp.run();
        assertThat(mmas_tsp.getGlobalStatistics().getBestSoFar()).isEqualTo(43128.98399999998);
        assertThat(getTourString(mmas_tsp)).isEqualTo("[41, 13, 0, 24, 5, 31, 17, 25, 42, 4, 36, 21, 3, 29, 14, 6, 9, 12, 30, 11, 46, 44, 20, 19, 32, 2, 45, 35, 37, 8, 16, 15, 18, 1, 10, 39, 40, 23, 43, 27, 34, 28, 33, 7, 22, 26, 38, 41]");
    ...
    public void test_MMAS_tsp_joinville78_with_seed_1() {
        ...
        mmas_tsp.setShowLog(false);
        mmas_tsp.run();
        assertThat(mmas_tsp.getGlobalStatistics().getBestSoFar()).isEqualTo(54915.86299999997);
        assertThat(getTourString(mmas_tsp)).isEqualTo("[18, 76, 50, 63, 49, 60, 30, 78, 12, 9, 14, 6, 29, 66, 3, 21, 36, 42, 4, 17, 56, 19, 45, 57, 2, 32, 22, 51, 26, 38, 64, 13, 71, 72, 0, 74, 41, 24, 5, 31, 25, 11, 46, 44, 58, 20, 77, 35, 37, 8, 48, 16, 67, 68, 15, 52, 70, 23, 27, 53, 62, 34, 28, 33, 59, 69, 7, 54, 65, 43, 73, 40, 47, 75, 39, 55, 61, 1, 10, 18]");
